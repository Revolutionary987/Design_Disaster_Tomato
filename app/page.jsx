...
// ============================================================================
const PRODUCTS = [
  { id: 1,  name: "Organic Gala Apples",    price: 4.20,  img:'https://picsum.photos/800/800?random=3',   rating:4.7, distance:1.5, isOrganic:true,  category:"fruits",    unit:"1 kg" },
  { id: 2,  name: "Haas Avocado",           price: 2.50,  img:'https://picsum.photos/800/800?random=4',   rating:4.6, distance:0.5, category:"fruits",    unit:"2 pcs" },
  { id: 3,  name: "Ripe Mangoes",           price: 7.99,  img:'https://picsum.photos/800/800?random=31',  rating:4.8, distance:1.0, category:"fruits",    unit:"6 pack" },
  { id: 4,  name: "Alphonso Strawberries",  price: 5.50,  img:'https://picsum.photos/800/800?random=32',  rating:4.9, distance:0.6, category:"fruits",    unit:"250 g" },
  { id: 5,  name: "Seedless Red Grapes",    price: 3.99,  img:'https://picsum.photos/800/800?random=33',  rating:4.5, distance:1.3, category:"fruits",    unit:"500 g" },
  { id: 6,  name: "Cherry Tomatoes",        price: 2.99,  img:'https://picsum.photos/800/800?random=41',  rating:4.6, distance:0.8, category:"veggies",   unit:"200 g" },
  { id: 7,  name: "Organic Baby Spinach",   price: 3.50,  img:'https://picsum.photos/800/800?random=42',  rating:4.8, distance:0.5, isOrganic:true,  category:"veggies",   unit:"150 g" },
  { id: 8,  name: "Broccoli Crown",         price: 2.20,  img:'https://picsum.photos/800/800?random=43',  rating:4.5, distance:1.2, category:"veggies",   unit:"1 pc" },
  { id: 9,  name: "Sweet Bell Peppers",     price: 3.80,  img:'https://picsum.photos/800/800?random=44',  rating:4.7, distance:0.9, category:"veggies",   unit:"3 pcs" },
  { id: 10, name: "Purple Cabbage",         price: 1.99,  img:'https://picsum.photos/800/800?random=45',  rating:4.4, distance:1.5, isOrganic:true,  category:"veggies",   unit:"1 pc" },
  { id: 11, name: "Aged Cheddar Cheese",    price: 9.50,  img:'https://picsum.photos/800/800?random=6',   rating:4.5, distance:1.8, category:"dairy",     unit:"200 g" },
  { id: 12, name: "Free-range Large Eggs",  price: 5.99,  img:'https://picsum.photos/800/800?random=7',   rating:4.8, distance:0.9, category:"dairy",     unit:"12 pcs" },
  { id: 13, name: "Organic Brown Eggs",     price: 7.50,  img:'https://picsum.photos/800/800?random=8',   rating:4.9, distance:0.4, isOrganic:true,  category:"dairy",     unit:"6 pcs" },
  { id: 14, name: "Greek Yogurt",           price: 4.20,  img:'https://picsum.photos/800/800?random=51',  rating:4.7, distance:1.1, category:"dairy",     unit:"400 g" },
  { id: 15, name: "Unsalted Butter",        price: 3.99,  img:'https://picsum.photos/800/800?random=52',  rating:4.6, distance:0.7, category:"dairy",     unit:"250 g" },
  { id: 16, name: "Artisanal Sourdough",    price: 6.50,  img:'https://picsum.photos/800/800?random=2',   rating:4.9, distance:1.2, category:"bakery",    unit:"1 loaf" },
  { id: 17, name: "Whole Grain Baguette",   price: 3.99,  img:'https://picsum.photos/800/800?random=61',  rating:4.7, distance:0.8, category:"bakery",    unit:"1 pc" },
  { id: 18, name: "Cinnamon Bagels",        price: 5.20,  img:'https://picsum.photos/800/800?random=62',  rating:4.8, distance:1.0, category:"bakery",    unit:"4 pcs" },
  { id: 19, name: "Croissants",             price: 7.00,  img:'https://picsum.photos/800/800?random=63',  rating:4.9, distance:0.6, category:"bakery",    unit:"4 pcs" },
  { id: 20, name: "Premium Spring Water",   price: 2.99,  img:'https://picsum.photos/800/800?random=1',   rating:4.8, distance:0.8, category:"beverages", unit:"1 L" },
  { id: 21, name: "Dark Roast Coffee",      price: 18.00, img:'https://picsum.photos/800/800?random=5',   rating:4.9, distance:2.0, category:"beverages", unit:"500 g" },
  { id: 22, name: "Cold Brew Concentrate",  price: 14.50, img:'https://picsum.photos/800/800?random=71',  rating:4.8, distance:1.3, category:"beverages", unit:"500 ml" },
  { id: 23, name: "Matcha Green Tea",       price: 16.00, img:'https://picsum.photos/800/800?random=72',  rating:4.7, distance:1.0, category:"beverages", unit:"100 g" },
  { id: 24, name: "Fresh Orange Juice",     price: 6.99,  img:'https://picsum.photos/800/800?random=73',  rating:4.6, distance:0.4, category:"beverages", unit:"1 L" },
  { id: 25, name: "Mixed Nuts",             price: 8.50,  img:'https://picsum.photos/800/800?random=81',  rating:4.7, distance:1.1, category:"snacks",    unit:"200 g" },
  { id: 26, name: "Dark Chocolate 80%",     price: 5.99,  img:'https://picsum.photos/800/800?random=82',  rating:4.8, distance:0.9, category:"snacks",    unit:"100 g", isFlashDeal:true, originalPrice:8.99 },
  { id: 27, name: "Kettle Corn",            price: 4.50,  img:'https://picsum.photos/800/800?random=83',  rating:4.5, distance:0.6, category:"snacks",    unit:"150 g" },
  { id: 28, name: "Rice Cakes",             price: 3.20,  img:'https://picsum.photos/800/800?random=84',  rating:4.4, distance:1.4, category:"snacks",    unit:"100 g" },
  { id: 29, name: "Grass-fed Ground Beef",  price: 12.99, img:'https://picsum.photos/800/800?random=91',  rating:4.7, distance:1.5, category:"meat",      unit:"500 g" },
  { id: 30, name: "Chicken Breast",         price: 8.50,  img:'https://picsum.photos/800/800?random=92',  rating:4.8, distance:0.8, category:"meat",      unit:"500 g", isFlashDeal:true, originalPrice:11.99 },
  { id: 31, name: "Atlantic Salmon Fillet", price: 14.00, img:'https://picsum.photos/800/800?random=93',  rating:4.9, distance:1.2, category:"meat",      unit:"300 g" },
  { id: 32, name: "Jumbo Shrimp",           price: 11.50, img:'https://picsum.photos/800/800?random=94',  rating:4.6, distance:1.0, category:"meat",      unit:"400 g" },
  { id: 33, name: "Dutch Cocoa Powder",     price: 12.00, img:'https://picsum.photos/800/800?random=9',   rating:4.7, distance:1.1, category:"pantry",    unit:"250 g" },
  { id: 34, name: "Extra Virgin Olive Oil", price: 13.50, img:'https://picsum.photos/800/800?random=101', rating:4.8, distance:0.7, category:"pantry",    unit:"500 ml", isFlashDeal:true, originalPrice:17.99 },
  { id: 35, name: "Basmati Rice",           price: 4.99,  img:'https://picsum.photos/800/800?random=102', rating:4.6, distance:1.3, category:"pantry",    unit:"1 kg" },
  { id: 36, name: "Organic Honey",          price: 9.99,  img:'https://picsum.photos/800/800?random=103', rating:4.9, distance:0.5, isOrganic:true,  category:"pantry",    unit:"320 g" },
  { id: 37, name: "Whole Wheat Flour",      price: 3.49,  img:'https://picsum.photos/800/800?random=110', rating:4.5, distance:0.9, category:"pantry",    unit:"1 kg" },
  { id: 38, name: "Cane Sugar",             price: 2.49,  img:'https://picsum.photos/800/800?random=111', rating:4.4, distance:1.0, category:"pantry",    unit:"500 g" },
];
